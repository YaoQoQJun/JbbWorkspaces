  ...
  <head>
    ...
    <script type="text/javascript">
    	function seeLinkSoftware(extension_id,link){
    		...
    		window.location.href="<%=basePath%>monitor/seeLinkSoftware.do?extension_id="+extension_id+"&link="+link;
    	}
    	function seeLinkHardware(extension_id,link){
    		link=link.replace(/&/g,"%26");
    		window.location.href="<%=basePath%>monitor/seeLinkHardware.do?extension_id="+extension_id+"&link="+link;
    	}
  ...
  <body class="pl15">
	...
	<div class="centMain">
		...
		$.ajax({
			...
			data:{"link":link,"channel_id":'${extension.channel_id}',"dataItem_id":${dataItem.id}},
		...
		function changeDatas(dataItem_id,e){
			...
			$.ajax({
				type:"post",
				url:"monitor/getLinkSoftWareDatas.do",
				data:{"link":link,"channel_id":'${extension.channel_id}',"dataItem_id":dataItem_id},
				success:function(msg){
					datas1=msg.datas1;
					datas2=msg.datas2;
					$(".keyi").text(msg.counts[0]);
