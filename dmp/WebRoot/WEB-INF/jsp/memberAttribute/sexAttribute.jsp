	...
	<div class="centMain">
		...
		<script type="text/javascript">
			...
			function searchDate(){
				...
				window.location.href="<%=basePath%>memberAttribute/toSexAttribute.do?startDate="+startDate+"&endDate="+endDate+"&regFrom="+regFrom;
			}
			...
			$.ajax({
				type:"post",
				url:"memberAttribute/getSexDatas.do",
